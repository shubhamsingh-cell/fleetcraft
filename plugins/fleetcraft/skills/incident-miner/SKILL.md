---
name: incident-miner
description: Turn a resolved incident or hard-won fix into an evidence-backed lesson or skill proposal. Gather read-only evidence and stop for approval before writing durable records.
---
