...
owner, and audit trail exist. Fleetcraft v0.1.1 deliberately ships no model-switch
behavior. Do not emulate that guarantee with prompt text; a future capability requires a
separately installable, validated extension.
